...
curr_dir = Path.cwd()
model_dir = curr_dir/"sentiment_model"
...
df = pd.read_csv("./internal/models/sentiments/IMDB_Dataset.csv", encoding="utf-8-sig")
df = df[["review", "sentiment"]]
df = df.rename(columns={"review": "text", "sentiment": "labels"})
...
if model_dir.exists():
    ...
    model = AutoModelForSequenceClassification.from_pretrained("./internal/models/sentiments/sentiment_model", num_labels=2)
else: 
...
training_args = TrainingArguments(
    output_dir="./internal/models/sentiments/sentiment_model",
...
print(results)
trainer.save_model("./internal/models/sentiments/sentiment_model")
tokenizer.save_pretrained("./internal/models/sentiments/sentiment_model")